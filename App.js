...
const styles = StyleSheet.create({
  ...
  dropdownFinance: { position: 'absolute', top: 80, left: 20, width: '20%', maxHeight: 200, borderWidth: 1, borderColor: '#1f2a36', backgroundColor: '#0f1520', borderRadius: 8, zIndex: 50, opacity: 1 },
  dropdownJournal: { position: 'absolute', top: 80, left: '20%', width: '20%', maxHeight: 200, borderWidth: 1, borderColor: '#1f2a36', backgroundColor: '#0f1520', borderRadius: 8, zIndex: 50, opacity: 1 },
  dropdownPlanner: { position: 'absolute', top: 80, left: '40%', width: '20%', maxHeight: 200, borderWidth: 1, borderColor: '#1f2a36', backgroundColor: '#0f1520', borderRadius: 8, zIndex: 50, opacity: 1 },
